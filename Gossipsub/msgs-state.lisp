...
(definecd update-waitingfor (mst :msgs-state pids :lopid sender :peer) :msgs-state
  (mset :waitingfor (add-pid-peers pids sender (msgs-state-waitingfor mst))
        mst))

(defun nth-msg-peer-custom (n)
  (cons (nth-payload-type n) (nth-peer n)))

(defdata-attach msg-peer :enumerator nth-msg-peer-custom)

(defun msg-peer-age-custom-help (i n)
  (if (zp i)
      nil
    (mset (nth-msg-peer-custom (+ n (* 123 i)))
          n
          (msg-peer-age-custom-help (1- i) n))))

(defun nth-msg-peer-age-custom (n)
  (msg-peer-age-custom-help 5 n))

(defdata-attach msgpeer-age :enumerator nth-msg-peer-age-custom)

(defun new-msgs-state (d)
  (msgs-state (nth-msgpeer-age d) nil nil nil nil 0 0))
