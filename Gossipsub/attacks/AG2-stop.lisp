...
(time$
 ...
 SUB10 SUB11 SUB12))
    ...
    (eth-attack-violations grp evnts evnts 'A 'B attacktopics (* 10 (len evnts))
                           *eth-twp* 42 nil)))
...
; 58.53 seconds realtime, 37.49 seconds runtime
...
; 62.28 seconds realtime, 101.16 seconds runtime
...
; 37.00 seconds realtime, 22.07 seconds runtime
